var rhost="/test-tasks";var https_host="https://"+window.location.hostname+rhost+"/",_protocol=document.location.protocol;if(_protocol!="https"){var sq="",sqI=location.href.indexOf("?");if(sqI!=-1)sq=location.href.substring(sqI+1);if(location.href!=https_host+"?"+sq)location.href=https_host+"?"+sq}function getid(id){return document.getElementById(id)}function gebc(object){return document.getElementsByClassName(object)}
function sort_date(a,b){if(a["date"]<b["date"])return 1;else if(a["date"]>b["date"])return-1;else return 0}function screenSize(){var w,h;w=window.innerWidth?window.innerWidth:document.documentElement.clientWidth?document.documentElement.clientWidth:document.body.offsetWidth;h=window.innerHeight?window.innerHeight:document.documentElement.clientHeight?document.documentElement.clientHeight:document.body.offsetHeight;return{w:w,h:h}}
function cv_url(pageurl){try{parent.window.history.replaceState({path:pageurl},"",pageurl)}catch(e){}}function validateEmail(email){var re=/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return re.test(String(email).toLowerCase())}
